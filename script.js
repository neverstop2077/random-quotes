var btnQuotes = document.querySelector(".btn.btn-info.quotes-btn");
var quotesLine = document.getElementById("quotes-word");
var authorLine = document.getElementById("quotes-author");
...
authors = Object.keys(quotesContainer);

btnQuotes.onclick = function(){
    var random_index = Math.floor(Math.random() * authors.length);

    quotesLine.innerHTML = quotesContainer[authors[random_index]];
    authorLine.innerHTML = authors[random_index];
}